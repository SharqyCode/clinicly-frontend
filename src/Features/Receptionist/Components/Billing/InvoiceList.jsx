            ...
            <tbody>
              {invoices.map((inv) => (
                <tr key={inv._id} className="hover:bg-bg-light-secondary">
                  ...
                  <td className="font-mono text-sm">{inv.appointment}</td>
                  <td className="font-mono text-sm">{inv.patient}</td>
                  <td>EGP {inv.baseAmount}</td>
                  <td>
                    {inv.discount} {inv.discountType === "percentage" ? "%" : "EGP"}
                  </td>
